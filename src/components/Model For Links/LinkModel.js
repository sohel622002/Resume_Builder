...
function LinkModel(props) {
    ...
    // console.log('this is previous data', preveousData)

    return (
        <div className='backDrop' onClick={props.openModelCloserHandler}>
            <div className='model'>
                <div className='navigation'>
                    <button className='discard' onClick={props.onDiscardClick}>Discard</button>
                    <button className='save' onClick={passMainLinks}>Save</button>
                </div>
                ...
                <div className='secondary_navigation'>
                    <div className='sociallink_container'>
                        <div className='socialLinks main_contact' onClick={props.showMainLinks}>Main Contact</div>
                        <div className='socialLinks social' onClick={props.showSocialLinks}>Social</div>
                    </div>
                </div>
                <div className="main_Link_Container">
                    ...
                    <div className='main_contect_inputs'>
                        <i className="fa-solid fa-mobile-button" style={{ color: "#ffffff" }} />
                        <div>
                            <label>Phone</label>
                            <input
                                name='phone'
